...
public class VerifyAuditLogForNewLabRequest extends AbstractAuditTest {
	...
	@Test(groups = {"firefox", "iexplore", "safari", "default" }, description = "Test for verifying audit log for New labRequest")
	...
	/**
	 * @Function 	: verifyAuditLogsForNewLabRequest
	 * @Description : Function to  verify audit log for New labRequest
	 * @param 		: selinumHost
	 * @param		: seleninumPort
	 * @param 		: browser
	 * @param		: website
