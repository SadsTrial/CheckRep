...
public class UpdatePreferredDrugList extends AbstractPreferenceTest{
	...
	@Test(groups = {"firefox", "iexplore", "safari", "default" }, description = "Test for Updating the preferred drug list")
	 ...
	 * @Description : Function to verify Create  Preferred DrugList
	 * @param 		: selinumHost
	 * @param		: seleninumPort
	 * @param 		: browser
	 * @param		: website
